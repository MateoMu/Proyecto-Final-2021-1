...
void basedatos::crearTabladeUsuarios()
{
...
void basedatos::crearTabladeDatos()
{
...
void basedatos::crearTabladeEnemigos()
{
    //Name-Vida-Score-Num_jug-turno
    QString consulta;
...
void basedatos::crearTabladeRecords()
{
     //Name-Puntaje
    QString consulta;
...
void basedatos::insertarUsuario()
{
    QString consulta;
...
void basedatos::insertarUsuario(QString user, QString passw)
{
    QString consulta;
    consulta.append("INSERT INTO usuarios("
                    "nombre,"
...
bool basedatos::insertarDatos(QString match_name,QString username,bool arcade,int nivel,int player,int blood,int gameTime,int score_1,int score_2,int ammo1,int ammo2,int ammo3)
{
    bool success = false;
    QString consulta;
...
bool basedatos::insertarEnemigos(QString match_name,QString username,int x, int y, int v0,int angle,int move)
{
    bool success = false;
    QString consulta;
...
void basedatos::insertarRecord(QString name,QString high_score, QString player)
{
    QString consulta;
    consulta.append("INSERT INTO record("
                    "nombre ,"
...
void basedatos::mostrarUsuarios()
{
    int i=0;
    QString consulta;
...
vector<QString> basedatos::mostrarDatos(QString match_name,QString username)
{
    QString r1,r2;
    vector<QString> data;
    QString consulta;
...
vector<QString> basedatos::mostrarEnemigos(QString match_name, QString username)
{
    QString r1,r2;
...
vector<QString> basedatos::mostrarRecord()
{
    vector<QString> data;
    QString r1,r2,r3;
    QString consulta;
...
vector<QString> basedatos::mostrarPartidas(QString username)
{
    QString r1,r2,r = "";
    vector<QString> data;
    QString consulta;
...
bool basedatos::validarUsuario(QString _name, QString _psswd)
{
    QString consulta;
    bool exist=false;
    consulta.append("SELECT * FROM usuarios"
...
bool basedatos::validarMatchName(QString name)
{
...
QString basedatos::getName_partida() const
{
    return name_partida;
}

void basedatos::setName_partida(const QString &value)
{
    name_partida = value;
}

QString basedatos::getName() const
{
    return name;
}

void basedatos::setName(const QString &value)
{
    name = value;
}

bool basedatos::getUser() const
{
    return user;
}

void basedatos::setUser(bool value)
{
    user = value;
}

bool basedatos::getPassword() const
{
    return password;
}

void basedatos::setPassword(bool value)
{
    password = value;
}
