...
void MainWindow::addItems2Scene(int opc)
{
    ...
    switch (opc) {
        case 1:
            addObjetoGrafico(":/new/prefix1/Imagenes/enemigo.jpg",desk_widht/8,2*desk_height/4,200,300,true);
            setPosSir(desk_widht/8,2*desk_height/4);
            label1->setGeometry((desk_widht/2)-150,desk_height/10,100,50);
            label1->setStyleSheet("border-image:url(:/new/prefix1/Imagenes/next.jpg);");
            p.setColor(QPalette::Background, bg_color);
            label1->setPalette(p);
                ///BOTONES
            //boton->setGeometry(100,50,100,80);
            boton2->setGeometry(100,150,100,80);
            boton2->setStyleSheet("border-image:url(:/new/prefix1/Imagenes/Bala1.jpg);");
            boton2->setPalette(p);
            boton3->setGeometry(200,150,100,80);
            boton3->setStyleSheet("border-image:url(:/new/prefix1/Imagenes/Bala1.jpg);");
            boton3->setPalette(p);
        ...
        case 2:
            ...
            addObjetoGrafico(main_caracter_path,(2*desk_widht/8)-50,(3*desk_height/4)-50,w_sir,h_sir,true);
...
//            display_ammo2->display(ammu2);
            display_ammo3->setGeometry((7*desk_widht/8)-210,80,80,50);
...
///         MANEJO DE BASE DE DATOS PARA GAURDAR Y CARGAR         ///
...
bool MainWindow::saveListEnemies(vector<objetos_movil* > vec)
{
    bool success = true,success2 = true;
    vector<objetos_movil* >::iterator it;
...
{
    ///DECLARACION DE OBJETOS
    QString ruta = ":/new/prefix1/Imagenes/Bala1.png"; int x=0; int y=100; int w=80; int h=80;
...
void MainWindow::setDatabase(basedatos *value)
{
    database = value;
}
